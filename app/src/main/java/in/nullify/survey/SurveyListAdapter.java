...
public class SurveyListAdapter extends ArrayAdapter<SurveyHome> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView uba_id = (TextView) v.findViewById(R.id.uba_id);
        TextView owner = (TextView) v.findViewById(R.id.owner_name);
        TextView adress = (TextView) v.findViewById(R.id.address);

        uba_id.setText("UBA id : "+surveys.get(position).getUba_id());
        owner.setText(surveys.get(position).getOwner());
        adress.setText("House Number :"+surveys.get(position).getHouseno()+"\n"+"Ward Number : "+surveys.get(position).getWardno()+"\n"+surveys.get(position).getVillage()+" ,"+
