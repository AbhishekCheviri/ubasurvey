...
public class ProfileActivity extends AppCompatActivity {
    ...
    private LiveStockListAdapter liveStockListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        liveStockListAdapter = new LiveStockListAdapter(ProfileActivity.this);
        ...
        ItemTouchHelper.SimpleCallback itemTouchHelperCallback = new RecyclerItemTouchHelperFamily(0, ItemTouchHelper.LEFT,
                new RecyclerItemTouchHelperFamily.RecyclerItemTouchHelperListener() {
                    ...
                    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction, int position) {
                        ...
                        builder.setMessage(
                                "Do you want to delete this livestock?")
                                .setCancelable(false)
        ...
        ItemTouchHelper.SimpleCallback itemTouchHelperCallback5 = new RecyclerItemTouchHelperLive(0, ItemTouchHelper.LEFT,
                new RecyclerItemTouchHelperLive.RecyclerItemTouchHelperListener() {
                    @Override
                    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction, int position) {
                        ...
                        builder.setMessage(
                                ...
                                .setPositiveButton("ok",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog,
                                                                int id) {
                                                DeleteLive(deletedItem.getL_id());
                                            }
                                        })
                                .setNegativeButton("cancel",
                                        new DialogInterface.OnClickListener() {
        ...
        dataListAdapter = new DataListAdapter(ProfileActivity.this, schemes, values);
    ...
    private void InsertLive() {
        ...
        String URL = "https://nullify.in/survey/api/insertLiveStock?id=" + id;
    ...
    private void DeleteLive(String id) {
        findViewById(R.id.progress).setVisibility(View.VISIBLE);
        RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
        String URL = "https://nullify.in/survey/api/deleteLiveStock?id=" + id;
    ...
    private void setHouseHoldInfo() {
        ...
        TextView uba = findViewById(R.id.uba_id);
        uba.setText(house.get("uba_id"));
        ...
        int i = irrigation.indexOf(house.get("irrigation"));
        irr.setSelection(i);
    ...
    private void Insertmember() {
        findViewById(R.id.progress).setVisibility(View.VISIBLE);
        RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
        String URL = "https://nullify.in/survey/api/insertMemberEdit?id=" + id;
                    ...
                    public void onResponse(String response) {
                        if (!response.equals("0")) {
                            ...
                            try {
                                ...
                                Log.d("schems", array.toString());
                                if (array.length() > 0) {
                                    c = array.getJSONObject(0);
                                    s_id=c.getString("s_id");
                                    for (int i = 0; i < skeys.length; i++)
                                        values.add(c.getString(skeys[i]));
                                    Log.d("schems2", values.toString());
                                }
                                ...
                                array = jsonObject.getJSONArray("stocks");
                                for (int i = 0; i < array.length(); i++) {
                                    JSONObject cc = array.getJSONObject(i);
                                    Stock a = new Stock();
                                    a.setL_id(cc.getString("l_id"));
                                    a.setName(cc.getString("anim_name"));
                                    a.setCount(cc.getString("count"));
                                    a.setShelter(cc.getString("shelter"));
                                    liveStocklist.add(a);
                                }
    ...
    private void saveStock() {
        ...
        for (int i = 0; i < liveStocklist.size(); i++) {
            ...
            String url = "https://nullify.in/survey/api/saveLive?";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        final MenuItem save = menu.getItem(0);
